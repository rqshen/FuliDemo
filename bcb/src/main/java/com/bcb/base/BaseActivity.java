...
//        }
    ...
    protected void onResume() {
        ...
        if (isAppOnForeground() && isLongerThanOneMinute()) {
            ...
            if (hasGesturePassword()) {
                Activity_Gesture_Lock.launche(BaseActivity.this, false, true);
            }
        }
    }
    ...
    private void showSettingGestureAlertView() {
        ...
        if(MyApplication.saveUserInfo.getAccess_Token() != null && MyApplication.saveUserInfo.isFirstLogin()&&!hasGesturePassword()) {
            ...
            AlertView.Builder ibuilder = new AlertView.Builder(BaseActivity.this);
...
//                    Activity_Gesture_Lock.launche(BaseActivity.this, true, true);
                    startActivity(new Intent(BaseActivity.this, Activity_Gesture_Lock.class));
                    alertView.dismiss();
                    alertView = null;
                }
            });
