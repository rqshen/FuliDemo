...
public class _UsedCouponFragment1 extends BaseFragment1 {

	private static final String TAG = "_UsedCouponFragment1";
    private Context ctx;
    ...
    public _UsedCouponFragment1(){
        super();
    }

    @SuppressLint("ValidFragment")
	public _UsedCouponFragment1(Context ctx) {
		super();
        this.ctx= ctx;	
	}
    ...
    private void loadData() {
        ...
        BcbJsonRequest jsonRequest = new BcbJsonRequest(UrlsOne.Select_Coupon, obj, TokenUtil.getEncodeToken(ctx), new BcbRequest.BcbCallBack<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                LogUtil.i("bqt", "【_UnusedCouponFragment1】【onResponse】已使用的优惠券" + response.toString());
                try {
