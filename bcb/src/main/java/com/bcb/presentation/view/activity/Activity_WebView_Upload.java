...
public class Activity_WebView_Upload extends Activity_Base {
	...
	public static void launche(Context ctx, String tittle, String url) {
		Intent intent = new Intent(ctx, Activity_WebView_Upload.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = this;
		MyActivityManager.getInstance().pushOneActivity(Activity_WebView_Upload.this);
...
//			mIntentUrl = getUrlStrWithDES();
	...
	private WebChromeClient mWebChromeClient = new WebChromeClient() {
		...
		public void openFileChooser(ValueCallback<Uri> uploadMsg) {
			...
			i.setType("image/*");
			Activity_WebView_Upload.this.startActivityForResult(Intent.createChooser(i, "Image Chooser"), FILECHOOSER_RESULTCODE);
		...
		public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
			...
			i.addCategory(Intent.CATEGORY_OPENABLE);
			i.setType("image/*");
			Activity_WebView_Upload.this.startActivityForResult(Intent.createChooser(i, "Image Chooser"), Activity_WebView_Upload.FILECHOOSER_RESULTCODE);
		}
