package com.bcb.presentation.view.custom.ImageCycleView;
...
import com.bcb.presentation.view.custom.CycleViewPager.CycleViewPager;
 ...
 * 使用：只需在xml文件中使用，然后在页面中调用setImageResources(ArrayList, ImageCycleViewListener)即可
 * 
...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(ArrayList<BannerInfo> infoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
	...
	private class ImageCycleAdapter extends PagerAdapter {
		 ...
		 * 图片资源列表
		 */
		private ArrayList<BannerInfo> mAdList = new ArrayList<BannerInfo>();
		...
		public ImageCycleAdapter(Context context, ArrayList<BannerInfo> adList, ImageCycleViewListener imageCycleViewListener) {
			mContext = context;
			mAdList = adList;
		...
		public Object instantiateItem(ViewGroup container, final int position) {
			...
			String	imageUrl = mAdList.get(position).ImageUrl;
