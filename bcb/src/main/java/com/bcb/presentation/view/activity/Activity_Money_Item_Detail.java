...
public class Activity_Money_Item_Detail extends Activity_Base {
		...
		BcbJsonRequest jsonRequest = new BcbJsonRequest(UrlsOne.MoneyItemDetail, obj, TokenUtil.getEncodeToken(this), new BcbRequest
			...
			public void onResponse(JSONObject response) {
				...
				try {
					...
					LogUtil.i("bqt", "【Activity_Money_Item_Detail】【onResponse】" + e.toString());
	...
	private void setupViewData() {
		...
		//设置金额，收入支付类型（1收入0支出）
		if (moneyItemDetailBean.Type == 0) value_amount.setText("-" + String.format("%.2f", moneyItemDetailBean.Amount));
