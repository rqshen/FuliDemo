...
public class DialogBQT2 extends Dialog implements OnClickListener {
	 ...
	 * 仿iOS风格的AlertView
	 */
	public DialogBQT2(Context context) {
		this(context, R.style.alertviewstyle);
	}

	public DialogBQT2(Context context, int theme) {
		super(context, theme);
		initView();
	}

	private void initView() {
		setContentView(R.layout.dialog_withicon2);
