...
// * 投资记录
// */
//public class Activity_Trading_Record2 extends Activity_Base {
//
...
//        intent.setClass(ctx, Activity_Trading_Record2.class);
...
//        myActivityManager.pushOneActivity(Activity_Trading_Record2.this);
...
//        mTradingRecordAdapter = new TradingRecordAdapter(Activity_Trading_Record2.this, recordsBeans);
...
//                if (HttpUtils.isNetworkConnected(Activity_Trading_Record2.this)) {
//                    PageNow = 1;
//                    recordsBeans.clear();
//                    loadTradingRecordData();
//                    loadmore_view.setVisibility(View.VISIBLE);
//                } else {
//                    ToastUtil.alert(Activity_Trading_Record2.this, "网络异常，请稍后再试");
...
//
//                try {
//                    if (PackageUtil.getRequestStatus(response, Activity_Trading_Record2.this)) {
