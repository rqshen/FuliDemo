 ...
 * 1、产品列表
 */
public class Activity_CP extends Activity_Base_Fragment implements View.OnClickListener {
...
//		setTitleValue("产品列表");
	...
	private void InitViewPager() {
		...
		fragmentsList.add(Frag_WYB.newInstance(0));
		fragmentsList.add(Frag_WYB.newInstance(1));
