...
public class Activity_LoanList_Detail extends Activity_Base_Fragment {
    ...
    public static void launche(Context context, String uniqueId, String assetCode) {
        ...
        intent.setClass(context, Activity_LoanList_Detail.class);
    ...
    private void setupViewPager() {
        ...
        Fragment detailFragment = new Frag_LoanDetail(Activity_LoanList_Detail.this, uniqueId);
        Fragment repaymentFragment = new Frag_Repayment(Activity_LoanList_Detail.this, assetCode);
