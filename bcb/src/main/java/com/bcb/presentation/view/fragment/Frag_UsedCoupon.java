...
public class Frag_UsedCoupon extends Frag_Base {

	private static final String TAG = "Frag_UsedCoupon";
    private Context ctx;
    ...
    public Frag_UsedCoupon(){
        super();
    }

    @SuppressLint("ValidFragment")
	public Frag_UsedCoupon(Context ctx) {
		super();
        this.ctx= ctx;	
	}
    ...
    private void loadData() {
        ...
        BcbJsonRequest jsonRequest = new BcbJsonRequest(UrlsOne.Select_Coupon, obj, TokenUtil.getEncodeToken(ctx), new BcbRequest.BcbCallBack<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                LogUtil.i("bqt", "【Frag_UnusedCoupon】【onResponse】已使用的优惠券" + response.toString());
                try {
