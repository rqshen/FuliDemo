 ...
 * 1、产品列表
 */
public class _CP extends BaseActivity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MyActivityManager.getInstance().pushOneActivity(_CP.this);
...
//		setTitleValue("产品列表");
	...
	private void InitViewPager() {
		...
		fragmentsList.add(_WYBFragment.newInstance(0));
		fragmentsList.add(_WYBFragment.newInstance(1));
