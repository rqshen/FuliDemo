...
public class AlertView extends Dialog {
	...
	public static class Builder {
		...
		public AlertView create() {
			...
			final AlertView dialog = new AlertView(context, R.style.alertviewstyle);
			View layout = inflater.inflate(R.layout.alertview, null);
			dialog.addContentView(layout, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams
					.WRAP_CONTENT));
			...
			//                        new ViewGroup.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams
			// .WRAP_CONTENT));
			//            }
