 ...
 * 1、债权变更
 */
public class Activity_Trading_change extends Activity_Base_Fragment implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MyActivityManager.getInstance().pushOneActivity(Activity_Trading_change.this);
	...
	private void InitViewPager() {
		...
		//	状态 1 转让中 0已完成
		fragmentsList.add(Frag_Change_In.newInstance(1));
		fragmentsList.add(Frag_Change_In.newInstance(0));
