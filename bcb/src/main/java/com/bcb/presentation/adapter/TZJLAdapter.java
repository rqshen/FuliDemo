...
public class TZJLAdapter extends BaseAdapter {
	...
	//默认标的构造方法
	public TZJLAdapter(Context ctx, List<TZJLbean.InvetDetailBean.RecordsBean> data) {
		this.ctx = ctx;
		this.data = data;
	}
	...
	static class ViewHolder {
		...
		@BindView(R.id.left) RelativeLayout left;
		@BindView(R.id.je) TextView je;
		@BindView(R.id.tzts) TextView tzts;
		@BindView(R.id.right) RelativeLayout right;
