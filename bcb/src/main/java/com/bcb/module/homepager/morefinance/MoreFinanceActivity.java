 ...
 * 投资理财 列表
 */
public class MoreFinanceActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyActivityManager.getInstance().pushOneActivity(MoreFinanceActivity.this);
