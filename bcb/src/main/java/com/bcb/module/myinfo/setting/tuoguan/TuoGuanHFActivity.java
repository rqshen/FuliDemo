package com.bcb.module.myinfo.setting.tuoguan;
 ...
 * 资金托管，汇付
 */
public class TuoGuanHFActivity extends Activity_Base implements View.OnClickListener {
    Context ctx;
    ...
    private void setOnClickListenerd() {
        tv_charge.setOnClickListener(TuoGuanHFActivity.this);
        tv_get.setOnClickListener(TuoGuanHFActivity.this);
        rl_look.setOnClickListener(TuoGuanHFActivity.this);
        rl_login.setOnClickListener(TuoGuanHFActivity.this);
        rl_find_deal.setOnClickListener(TuoGuanHFActivity.this);
        rl_find_login.setOnClickListener(TuoGuanHFActivity.this);
        rl_alert_deal.setOnClickListener(TuoGuanHFActivity.this);
        rl_unband.setOnClickListener(TuoGuanHFActivity.this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.rl_unband:
                ...
                break;
            case R.id.tv_charge:
                startActivity(new Intent(TuoGuanHFActivity.this, RechargeActivity.class));
                break;
            case R.id.tv_get:
                withdrawMoney();
                break;
    ...
    private void loginAccount() {
        ...
        String encodeToken = TokenUtil.getEncodeToken(TuoGuanHFActivity.this);
        LogUtil.i("bqt", "【TuoGuanHFActivity】【loginAccount】请求路径：" + requestUrl);
        BcbJsonRequest jsonRequest = new BcbJsonRequest(requestUrl, null, encodeToken, true, new BcbRequest.BcbCallBack<JSONObject>
            ...
            public void onResponse(JSONObject response) {
                LogUtil.i("bqt", "【TuoGuanHFActivity】【loginAccount】" + response.toString());
                if (PackageUtil.getRequestStatus(response, TuoGuanHFActivity.this)) {
                    try {
                        ...
                        if (result != null) {
                            ...
                            FundCustodianWebActivity.launche(TuoGuanHFActivity.this, "登录汇付账户", postUrl, postData);
                        }
                    } catch (Exception e) {
                        LogUtil.d("bqt", "【TuoGuanHFActivity】【loginAccount】" + e.getMessage());
                    }
                } else if (response != null) {
                    Toast.makeText(TuoGuanHFActivity.this, response.optString("message"), Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onErrorResponse(Exception error) {
                LogUtil.d("bqt", "【TuoGuanHFActivity】【loginAccount】网络异常，请稍后重试" + error.toString());
            }
        });
    ...
    private void alertLoginPassword(final String title) {
        ...
        String encodeToken = TokenUtil.getEncodeToken(TuoGuanHFActivity.this);
        LogUtil.i("bqt", "【TuoGuanHFActivity】【alertLoginPassword】请求路径：" + requestUrl);
        BcbJsonRequest jsonRequest = new BcbJsonRequest(requestUrl, null, encodeToken, true, new BcbRequest.BcbCallBack<JSONObject>
                () {
            @Override
            public void onResponse(JSONObject response) {
                LogUtil.i("bqt", "【TuoGuanHFActivity】【alertLoginPassword】" + response.toString());
                if (PackageUtil.getRequestStatus(response, TuoGuanHFActivity.this)) {
                    try {
                        /** 后台返回的JSON对象，也是要转发给汇付的对象 */
                        JSONObject result = PackageUtil.getResultObject(response);
                        if (result != null) {
                            ...
                            //传递的参数
                            String postData = HttpUtils.jsonToStr(result.toString()); //跳转到webview
                            FundCustodianWebActivity.launche(TuoGuanHFActivity.this, title, postUrl, postData);
                        }
                    } catch (Exception e) {
                        LogUtil.d("bqt", "【TuoGuanHFActivity】【alertLoginPassword】" + e.getMessage());
                    }
                } else if (response != null) {
                    Toast.makeText(TuoGuanHFActivity.this, response.optString("message"), Toast.LENGTH_SHORT).show();
                }
            ...
            @Override
            public void onErrorResponse(Exception error) {
                LogUtil.d("bqt", "【TuoGuanHFActivity】【alertLoginPassword】网络异常，请稍后重试" + error.toString());
            }
        });
        MyApplication.getInstance().getRequestQueue().add(jsonRequest);
    }
