package com.bcb.module.myinfo.setting;
 ...
 * 类说明：账号设置
 */
public class AccountSettingActivity extends Activity_Base implements OnClickListener, Interface_AccountSetting {
...
//	private ImageView company_arrow;
    ...
    public static void launche(Context ctx) {
        ...
        intent.setClass(ctx, AccountSettingActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myActivityManager.pushOneActivity(AccountSettingActivity.this);
    ...
    protected void onResume() {
        ...
        LogUtil.i("bqt", "【AccountSettingActivity】【onResume】保存的手势密码" + MyApplication.saveUserInfo.getGesturePassword());
...
//		company_arrow.setVisibility(View.VISIBLE);
        ...
        switch (v.getId()) {
            ...
            case R.id.layout_company:
                if (mUserDetailInfo == null || !mUserDetailInfo.HasOpenCustody) {
                    //                    Toast.makeText(AccountSettingActivity.this, "公司认证需要先开通汇付账户", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(this, FundCustodianAboutActivity.class));
                    return;
                }
                joinCompany();
            ...
            case R.id.layout_feedback:
                UmengUtil.feedback(AccountSettingActivity.this);
                break;
    ...
    private void joinCompany() {
        UmengUtil.eventById(AccountSettingActivity.this, R.string.self_auth_c2);
        if (mUserDetailInfo.MyCompany == null) {
            JoinCompanyActivity.launche(AccountSettingActivity.this);
    ...
    private void changeLoginPasswd() {
        Activity_Modify_Pwd.launche(AccountSettingActivity.this, true);
    }
    ...
    private void updateApp() {
        ToastUtil.alert(AccountSettingActivity.this, "检查更新中");
        UmengUtil.update(AccountSettingActivity.this);
    }
    ...
    private void aboutCompany() {
        ProjectDetailActivity.launche(AccountSettingActivity.this, "关于福利金融", UrlsOne.AboutConpany);
    }
...
//            ToastUtil.alert(this, message);
    ...
    private void gotoLoginActivity() {
        LoginActivity.launche(AccountSettingActivity.this);
        MyActivityManager myActivityManager = MyActivityManager.getInstance();
