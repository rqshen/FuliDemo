 ...
 * 类说明：当天已经领取每日福利的结果页面
 */
public class DailyWelfareStaticActivity extends Activity_Base implements View.OnClickListener {
    ...
    public static void launche(Context ctx, String welfare_value, String totalInterest, String joinCount, String[] rotateValues) {
        Intent intent = new Intent(ctx, DailyWelfareStaticActivity.class);
