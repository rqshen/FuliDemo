package com.bcb.module.myinfo.financial.financialstate;
 ...
 * 持有中，已结束，ViewPager
 */
public class FinancialStateFragment extends BaseFragment implements View.OnClickListener {
    private Context ctx;
     ...
     * 构造时把传入的参数带进来，
     */
    public static FinancialStateFragment newInstance(int Status) {
        Bundle bundle = new Bundle();
        bundle.putInt("Status", Status);
        FinancialStateFragment fragment = new FinancialStateFragment();
